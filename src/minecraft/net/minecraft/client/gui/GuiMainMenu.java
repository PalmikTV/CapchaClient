...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 + 105, j + 36 + 263, 98, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new GuiButton(4, this.width / 2 + 208, j + 287 + 12, 98, 20, I18n.format("menu.quit", new Object[0])));
        this.buttonList.add(new GuiButtonLanguage(5, this.width / 2 - 330, j + 287 + 12));
    ...
    {
        this.buttonList.add(new GuiButton(1, this.width / 2 - 305, p_73969_1_ +299, I18n.format("menu.singleplayer", new Object[0])));
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1 +275, I18n.format("menu.multiplayer", new Object[0])));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        GlStateManager.enableAlpha();
        capcha.backgrundAPI2.renderShader();
        Tessellator tessellator = Tessellator.getInstance();
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        int i = 274;
        ...
        f = f * 100.0F / (float)(this.fontRendererObj.getStringWidth("by Reave and PALMIK") + 32);
        GlStateManager.scale(f, f, f);
        this.drawCenteredString(this.fontRendererObj, "Capcha", -60, 10, -1);
        GlStateManager.popMatrix();
        String s = capcha.clientName + " " + capcha.clientVersion;
